...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="col-md-4 col-md-offset-4" style="margin-top:50px">
      <center>
        <h2>WEBSITE SMAN 1 TELUKJAMBE TIMUR</h2>
        <h3>LOGIN</h2>
    </center>
    <br>
    <?php
    if(isset($_GET['pesan'])){
      ...
      <a href="<?php echo base_url().'regis/regis_anggota'; ?>" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-plus"></span>Registrasi Siswa</a>
      </div></center>
