...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets2/datatable/datatables.css' ?>">
    ...
    <script type="text/javascript" src="<?php echo base_url().'assets2/datatable/jquery.datatables.js'; ?>"></script>
    <script type="text/javascript" src="<?php echo base_url().'assets2/datatable/datatables.js'; ?>"></script>
  </head>
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url().'admin/vote'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Data Vote</a></li>
            <li><a href="<?php echo base_url().'admin/grafik'; ?>"><span class="glyphicon glyphicon-folder-open"></span> Grafik Voting</a></li>
            <li><a href="<?php echo base_url().'admin/anggota'; ?>"><span class="glyphicon glyphicon-user"></span> Data Siswa</a></li>
            <li><a href="<?php echo base_url().'admin/calon'; ?>"><span class="glyphicon glyphicon-user"></span> Data Calon Ketua Osis</a></li>
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" ariaexpanded="false">
            <span class="glyphicon glyphicon-list-alt"></span> Laporan<span class="caret"></span></a>
            <ul class="dropdown-menu">
             <li><a href="<?php echo base_url().'admin/cetak_laporan_vote' ?>"><i class="glyphicon glyphicon-lock"></i>Laporan Data Vote</a></li>
          </ul>
        </li>
      </ul>
